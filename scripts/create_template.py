...
def create_settings_sheet(wb):
    ...
    data = [
        ...
        ("BH計画保存版_V9_KPNo列番号", 10, "保存版のKP-No列番号（実際のファイルで確認すること）"),
        ...
        ("列番号_属性(I列)", 9, ""),
        ("列番号_機械品番(H列)", 8, ""),
        ("列番号_shipment month(V列)", 22, ""),
        ("列番号_T-No(W列)", 23, ""),
        ("列番号_V8-LAZ型式(Y列)", 25, ""),
        ("列番号_V8-LAY型式(Z列)", 26, ""),
        ("列番号_Z002号機(AA列)", 27, ""),
        ("V8_ProductionScheduleパス", r"P:\Ｖ８－ＢＨ　Production schedule.xlsx", ""),
        ("V9_ProductionScheduleパス", r"P:\Ｖ９－ＢＨ　Production schedule.xlsx", ""),
        ("星取表計算マスターパス", r"P:\星取表計算ﾏｽﾀｰ.xlsx", ""),
        ("0110BHPlanパス", r"P:\0110BHPlan-1.xlsx", ""),
